    ...
    if (isExist == true) {
        ...
        if (canAfford == true) {
            ...
            for (let b = 0; b < items.length; b++) {
                if (item === items[b]) {
                    console.log(`The total purchase will be $${itemPrices[b] * quantity}. Your change will be $${cash - (itemPrices[b] * quantity)}.`);
                    cash = cash - (itemPrices[b] * quantity);
                    purchasedItems.push(items[b]);
